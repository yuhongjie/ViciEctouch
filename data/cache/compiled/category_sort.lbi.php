...
<div class="ect-wrapper">
  <form method="GET" class="sort" name="listform">
    ...
    <div class="category-list-show"> 
      <?php $_from = $this->_var['category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_31797900_1429091708');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_31797900_1429091708']):
        $this->_foreach['no']['iteration']++;
?> 
      <a href="<?php echo $this->_var['cat_0_31797900_1429091708']['url']; ?>" class="col-md-3 col-xs-3"><span><?php if ($this->_var['cat_0_31797900_1429091708']['cat_id']): ?><?php echo htmlspecialchars($this->_var['cat_0_31797900_1429091708']['name']); ?><?php else: ?><?php echo htmlspecialchars($this->_var['cat_0_31797900_1429091708']['name']); ?><?php endif; ?></span></a> 
